 ...
 */
/*: 
>(注意): あなたが新しく作成した構造体は型なので、ほかのすべての型（`String`や`Int`など）と同様に、名前を大文字で始める必要があります。また、プロパティ名は小文字で始める必要があります。これによって、コードを読む時に型と値を見分けやすくなります。
 */
/*: 
...
/*:
 */
//: - experiment:(実験): 新しい`Song`を作成してみてください。オートコンプリートのポップアップメニューに、メンバーワイズイニシャライザが含まれることに注意してください。
