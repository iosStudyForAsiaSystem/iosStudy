 ...
 */
/*: 
 以下のように、エラーとみなされます。「Cannot assign to value: 'name' is a 'let' constant」（値を代入できません。'name'は'let'定数です）というエラーが表示されています。`let`と _constant_（定数）が何を意味するか知っているので、このエラーの意味はわかりますね。
*/
let name = "Johnny"
name = "John"
/*:
 ...
 上のエラーでは、赤色の丸の中に白い点が入っています。 ![Fix-itエラー](FixItError.png)
 */
/*: 
