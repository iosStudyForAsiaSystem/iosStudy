 ...
 */
/*:
 - note:(注意): インデックス（index）の複数形は"indices"と書かれたり"indexes"と書かれたりします。
 */
/*:
...
/*: 
 - experiment:(実験 定数`favoriteDevice`を宣言し、`devices`配列に対するインデックスを使ってその値を"iPod"に設定してください。
*/
 ...
 */
/*:
 - experiment:(実験): リストのインデックス`4`のアイテムを取得しようとしてみてください。コンソールを開き、エラーに関する詳しい情報を確認します。
*/
